            ...
            <div class="col-md-6 col-lg-5">
                <div class="card">
                    <div class="card-body p-5">
                        <h2 class="card-title text-center mb-5"><i class="fas fa-user-circle me-2"></i>Login</h2>
                        <form id="loginForm">
                            <div class="mb-4">
                        ...
                        <p class="text-center mt-4">Don't have an account? <a href="register.php" class="text-primary">Register here</a></p>
                    </div>
                </div>
            </div>
        </div>
